...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver código http 400 quando as informações estao inválidas")
    @WithMockUser
    ...
    void agendar_cenario2() throws Exception {
        ...
        var dadosDetalhamento =  new DadosDetalhamentoConsulta(null, 9l, 5l, data);
        ...
        var response = mvc.perform(
                    post("/consultas")
                            ...
                            .content(dadosAgendamentoConsultaJacksonTester.write(
                                    new DadosAgendamentoConsulta(9l, 3l, data, especialidade)
                            ).getJson())
                )
                .andReturn().getResponse();
